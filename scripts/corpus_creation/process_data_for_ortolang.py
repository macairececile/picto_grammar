...
Example of use: python process_data_for_ortolang.py --datafile 'corpus_grammar.csv' --path_clips 'clips/' --outdir 'data_ortolang/'
"""
...
def create_data_for_ortolang(args):
    # corpus_name = ["cfpb", "cfpp", "clapi", "coralrom", "crfp", "fleuron", "frenchoralnarrative", "ofrom", "reunions", "tcof",
    #          "tufs", "valibel"]
